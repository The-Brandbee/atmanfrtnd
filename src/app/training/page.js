        ...
        <div className="row row-rever">
            <div className="col-lg-6 col-md-6 col-sm-12 hyper_personalized_box_row">
                <div className="hyper_personalized_box">
                    ...
                    <p>Turn dry compliance requirements into interactive learning. Atman makes it easy to deliver clear, consistent training on regulations, ethics, and industry standards — helping teams stay compliant and confident.</p>
                </div>
            </div>
            <div className="col-lg-6 col-md-6 col-sm-12">
                <div className="what_can_atman_do_img_box">
        ...
        <div className="row ">
            ...
            <div className="col-lg-6 col-md-6 col-sm-12 hyper_personalized_box_row">
                <div className="hyper_personalized_box">
                    ...
                    <p>Equip your teams for a global stage. With multilingual capabilities and cultural nuance, Atman trains employees to communicate and collaborate across markets, breaking down barriers and strengthening global operations.</p>
                </div>
            </div>
        </div>
